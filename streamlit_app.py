...
HOST = "marketoinsight-dev.us-east-1.snowflakecomputing.com"
#HOST = "adobe-marketoinsight-dev.snowflakecomputing.com"
DATABASE = "semantic_model"
SCHEMA = "definitions"
STAGE = "public"
FILE = "datahub_sample_poc.yaml"

CONN = snowflake.connector.connect(
    user="qizha",
    password=os.environ['SF_PASSWORD'],
    account="marketoinsight_dev",
    host=HOST,
    port=443,
    warehouse="B2B_INSIGHTS_COMPUTE_WH",
    role="SYSADMIN",
)
